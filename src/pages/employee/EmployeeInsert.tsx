...
const EmployeeInsert = () => {
  ...
  const onSubmitEmployee = async (data: InsertEmployeeJson) => {
    const resp = await InsertEmployeeService(data);
    if (resp === '200') {
      navigate(-1);
    } else if (resp === '404') {
                ...
                <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                  <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                    ...
                    <div className="mb-4">
                      ...
                      {touched.emp_username && errors.emp_username && (
                        <p className="mt-3 block text-sm font-medium text-danger ">
                          <ErrorMessage name="emp_username" />
                        </p>
                      )}
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      ...
                      {touched.emp_password && errors.emp_password && (
                        <p className="mt-3 block text-sm font-medium text-danger ">
                          <ErrorMessage name="emp_password" />
                        </p>
                      )}
                    </div>
                    <div className="mb-4">
